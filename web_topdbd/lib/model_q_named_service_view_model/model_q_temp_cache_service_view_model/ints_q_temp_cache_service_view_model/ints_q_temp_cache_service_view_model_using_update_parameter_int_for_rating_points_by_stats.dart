...
@immutable
base class IntsQTempCacheServiceViewModelUsingUpdateParameterIntForRatingPointsByStats<T extends Ints,Y extends ListInts<T>> extends BaseUpdateModelToNamedServiceParameterNamedDataSource<bool,int> {
  @protected
  ...
  async {
    try {
      tempCacheService.insertOrUpdateObjectToTempCache(KeysTempCacheServiceUtility.intsQRatingPointsByStats,parameter);
