...
base class DatesTimesQTempCacheServiceViewModelUsingGetNPForLastLoginTimeByLastLoginTimeUser<T extends DatesTimes,Y extends ListDatesTimes<T>> extends BaseGetModelFromNamedServiceNPDataSource<T> {
  @protected
