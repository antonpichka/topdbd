...
base class IntsQTempCacheServiceViewModelUsingGetNPForRatingPointsByStats<T extends Ints,Y extends ListInts<T>>
    implements IGetModelFromNamedServiceNPDataSource<T>
{
  ...
  async {
    try {
      ...
      return Ints.success(ratingPointsByStats) as T;
