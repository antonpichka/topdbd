...
@immutable
base class UpdateQQDiscordUserFirestoreQFirebaseFirestoreServiceQParameterUpdateUsernameAndGlobalNameToDiscordUserFirestoreUtility<T extends DiscordUserFirestore,Y extends ListDiscordUserFirestore<T>> {
  @protected
  final firebaseFirestoreService = FirebaseFirestoreService.instance;

  Future<Result<T>> updateDiscordUserFirestoreFirebaseFirestoreServiceParameterUpdateUsernameAndGlobalNameToDiscordUserFirestoreUtility(UpdateUsernameAndGlobalNameToDiscordUserFirestoreUtility parameter)
  async {
    try {
      ...
      if(!(listDocumentByDiscordUser?.docs[0].exists ?? false)) {
        return Result<T>.exception(LocalException(this,EnumGuiltyForLocalException.user,KeysExceptionUtility.updateQQDiscordUserFirestoreQFirebaseFirestoreServiceQParameterUpdateUsernameAndGlobalNameToDiscordUserFirestoreUtility));
      }
