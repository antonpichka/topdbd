...
base class CountryQFirebaseFirestoreServiceViewModelUsingGetParameterRegistrationCountryUtility<T extends Country,Y extends ListCountry<T>> extends BaseGetModelFromNamedServiceParameterNamedDataSource<T,RegistrationCountryUtility> {
  @protected
