...
@immutable
base class StringsQTempCacheServiceViewModelUsingUpdateParameterStringForUniqueIdByUser<T extends Strings,Y extends ListStrings<T>> extends BaseUpdateModelToNamedServiceParameterNamedDataSource<bool,String> {
  @protected
  ...
  async {
    try {
      tempCacheService.insertOrUpdateObjectToTempCache(KeysTempCacheServiceUtility.stringsQUniqueIdByUser,parameter);
