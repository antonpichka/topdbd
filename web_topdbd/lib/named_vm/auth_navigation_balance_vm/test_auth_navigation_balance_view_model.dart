...
@immutable
final class TestAuthNavigationBalanceViewModel extends BaseNamedViewModel<DataForAuthNavigationBalanceView,
    DefaultStreamWState<DataForAuthNavigationBalanceView>> implements IAuthNavigationBalanceViewModel
{
  // OperationEEModel(EEWhereNamed)[EEFromNamed]EEParameterNamedService
  // NamedUtility

  TestAuthNavigationBalanceViewModel(bool isAdminByRoleUser)
