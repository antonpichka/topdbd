...
@immutable
base class DatesTimesQTempCacheServiceViewModelUsingUpdateParameterDateTimeForEndOfSeasonTimeBySeason<T extends DatesTimes,Y extends ListDatesTimes<T>> extends BaseUpdateModelToNamedServiceParameterNamedDataSource<bool,DateTime> {
  @protected
