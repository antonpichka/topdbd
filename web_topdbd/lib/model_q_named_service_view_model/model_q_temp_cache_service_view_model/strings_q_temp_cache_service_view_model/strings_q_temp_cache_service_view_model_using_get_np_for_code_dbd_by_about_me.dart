...
base class StringsQTempCacheServiceViewModelUsingGetNPForCodeDBDByAboutMe<T extends Strings,Y extends ListStrings<T>> extends BaseGetModelFromNamedServiceNPDataSource<T> {
  @protected
