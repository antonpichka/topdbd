...
@immutable
final class TestTermsOfUseViewModel extends BaseNamedViewModel<DataForTermsOfUseView,DefaultStreamWState<DataForTermsOfUseView>>
    implements ITermsOfUseViewModel
{
  ...
  TestTermsOfUseViewModel() : super(DefaultStreamWState(DataForTermsOfUseView(true,"")));
