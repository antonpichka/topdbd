...
@immutable
base class DatesTimesQTempCacheServiceViewModelUsingUpdateParameterDateTimeForCreationTimeByUser<T extends DatesTimes,Y extends ListDatesTimes<T>> extends BaseUpdateModelToNamedServiceParameterNamedDataSource<bool,DateTime> {
  @protected
  ...
  async {
    try {
      tempCacheService.insertOrUpdateObjectToTempCache(KeysTempCacheServiceUtility.datesTimesQCreationTimeByUser,parameter);
