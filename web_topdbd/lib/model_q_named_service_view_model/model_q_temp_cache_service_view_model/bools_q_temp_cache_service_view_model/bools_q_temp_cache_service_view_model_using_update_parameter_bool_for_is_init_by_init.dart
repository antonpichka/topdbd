...
@immutable
base class BoolsQTempCacheServiceViewModelUsingUpdateParameterBoolForIsInitByInit<T extends Bools,Y extends ListBools<T>> extends BaseUpdateModelToNamedServiceParameterNamedDataSource<bool,bool> {
  @protected
  ...
  async {
    try {
      tempCacheService.insertOrUpdateObjectToTempCache(KeysTempCacheServiceUtility.boolsQIsInitByInit,parameter);
