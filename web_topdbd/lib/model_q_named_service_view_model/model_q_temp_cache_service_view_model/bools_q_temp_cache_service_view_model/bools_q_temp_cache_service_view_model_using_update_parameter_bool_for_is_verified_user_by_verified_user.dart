...
@immutable
base class BoolsQTempCacheServiceViewModelUsingUpdateParameterBoolForIsVerifiedUserByVerifiedUser<T extends Bools,Y extends ListBools<T>> extends BaseUpdateModelToNamedServiceParameterNamedDataSource<bool,bool> {
  @protected
  ...
  async {
    try {
      tempCacheService.insertOrUpdateObjectToTempCache(KeysTempCacheServiceUtility.boolsQIsVerifiedUserByVerifiedUser,parameter);
