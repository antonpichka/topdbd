...
base class StringsQTempCacheServiceViewModelUsingGetNPForGlobalNameByDiscordUser<T extends Strings,Y extends ListStrings<T>>
    implements IGetModelFromNamedServiceNPDataSource<T>
{
  ...
  async {
    try {
      ...
      return Strings.success(globalNameByDiscordUser) as T;
