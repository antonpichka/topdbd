...
base class StringsQTempCacheServiceViewModelUsingUpdateParameterStringForCodeDBDByAboutMe<T extends Strings,Y extends ListStrings<T>> extends BaseUpdateModelToNamedServiceParameterNamedDataSource<bool,String> {
  @protected
  ...
  async {
    try {
      tempCacheService.insertOrUpdateObjectToTempCache(KeysTempCacheServiceUtility.stringsQCodeDBDByAboutMe,parameter);
