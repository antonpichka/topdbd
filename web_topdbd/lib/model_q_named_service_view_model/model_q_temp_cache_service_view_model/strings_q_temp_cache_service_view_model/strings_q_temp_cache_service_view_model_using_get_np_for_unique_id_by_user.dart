...
base class StringsQTempCacheServiceViewModelUsingGetNPForUniqueIdByUser<T extends Strings,Y extends ListStrings<T>> extends BaseGetModelFromNamedServiceNPDataSource<T> {
  @protected
  ...
  async {
    try {
      ...
      return Result<T>.success(Strings(uniqueIdByUser) as T);
