...
base class StringsQTempCacheServiceViewModelUsingUpdateParameterStringForCodeSteamByAboutMe<T extends Strings,Y extends ListStrings<T>> extends BaseUpdateModelToNamedServiceParameterNamedDataSource<bool,String> {
  @protected
