...
base class StringsQTempCacheServiceViewModelUsingUpdateParameterStringForUsernameByDiscordUser<T extends Strings,Y extends ListStrings<T>> extends BaseUpdateModelToNamedServiceParameterNamedDataSource<bool,String> {
  @protected
  ...
  async {
    try {
      tempCacheService.insertOrUpdateObjectToTempCache(KeysTempCacheServiceUtility.stringsQUsernameByDiscordUser,parameter);
