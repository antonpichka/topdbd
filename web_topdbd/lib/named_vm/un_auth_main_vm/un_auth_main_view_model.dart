...
@immutable
final class UnAuthMainViewModel extends BaseNamedViewModel<DataForUnAuthMainView,DefaultStreamWState<DataForUnAuthMainView>>
    implements IUnAuthMainViewModel
{
  // OperationEEModel(EEWhereNamed)[EEFromNamed]EEParameterNamedService
  // NamedUtility

  UnAuthMainViewModel() : super(DefaultStreamWState(DataForUnAuthMainView(true)));
