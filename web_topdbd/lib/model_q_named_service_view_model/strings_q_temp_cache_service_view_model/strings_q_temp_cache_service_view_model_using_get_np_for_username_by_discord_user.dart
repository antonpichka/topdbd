...
base class StringsQTempCacheServiceViewModelUsingGetNPForUsernameByDiscordUser<T extends Strings,Y extends ListStrings<T>>
    implements IGetModelFromNamedServiceNPDataSource<T>
{
  ...
  async {
    try {
      ...
      return Strings.success(usernameByDiscordUser) as T;
