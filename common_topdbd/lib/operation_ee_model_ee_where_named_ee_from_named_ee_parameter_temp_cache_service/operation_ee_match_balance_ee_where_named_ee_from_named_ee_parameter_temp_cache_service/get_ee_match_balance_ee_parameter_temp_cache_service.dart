...
@immutable
base class GetEEMatchBalanceEEParameterTempCacheService<T extends MatchBalance,Y extends ListMatchBalance<T>> {
  @protected
  final tempCacheService = TempCacheService.instance;

  Result<T> getMatchBalanceParameterTempCacheService() {
    try {
      final matchBalance = tempCacheService.getFromKeyTempCacheParameterTempCache(KeysTempCacheServiceUtility.matchBalance) as T;
